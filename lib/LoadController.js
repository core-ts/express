...
exports.respondModel = exports.LoadController = void 0;
...
var LoadController = (function () {
  ...
  LoadController.prototype.load = function (req, res) {
    ...
    if (id) {
      this.view(id).then(function (obj) { return respondModel(obj, res); }).catch(function (err) { return response_1.handleError(err, res, _this.log); });
    }
  };
