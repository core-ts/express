...
function removeFieldByName(search, fieldName) {
  var i = search.indexOf(fieldName + "=")
  if (i < 0) {
    return search
  }
...
exports.removeFieldByName = removeFieldByName
function removeField(search, fieldName, excludePartial) {
  search = removeFieldByName(search, fieldName)
  if (!excludePartial) {
    search = removeFieldByName(search, resources_1.resources.partial)
    search = removeFieldByName(search, resources_1.resources.subPartial)
  }
  return search
}
exports.removeField = removeField
function removePage(search) {
  search = removeFieldByName(search, resources_1.resources.page)
  search = removeFieldByName(search, resources_1.resources.partial)
  search = removeFieldByName(search, resources_1.resources.subPartial)
  return search
}
...
function removeSort(search) {
  search = removeFieldByName(search, resources_1.resources.sort)
  search = removeFieldByName(search, resources_1.resources.partial)
  search = removeFieldByName(search, resources_1.resources.subPartial)
  return search
}
